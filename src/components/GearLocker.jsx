...
//       - Updated: Fixed Layout Blowout (Text Truncation).
//===============================================================

import { useState, useEffect } from 'react'
import { getGear, saveGear, deleteGear } from '../lib/gear'
import { Plus, Trash2, Edit, ExternalLink, Box, Wand2, Loader2, AlertTriangle, X } from 'lucide-react'
...
export function GearLocker() {
  ...
  async function handleAutoFill() {
      ...
      try {
          ...
          console.error(err)
          setError("Could not auto-fill. Site might be blocked or unsupported.")
          HAPTIC.error()
      } finally {
          setScraping(false)
      }
                    ...
                    <div className="flex h-full">
                        ...
                        <div className="flex-1 p-3 flex flex-col justify-between min-w-0">
                            <div>
                                ...
                                <p className="text-[10px] text-zinc-400 truncate">{item.brand} {item.model}</p>
                            </div>
