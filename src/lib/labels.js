...
<style>
  ...
  @media print {
    ...
    .label-card { transform: none !important; margin: 0 !important; box-shadow: none !important; page-break-inside: avoid; }
  }
...
<style>
  ...
  @media print {
    body { background: white; }
    .print-hint { display: none !important; }
    .label-card { transform: none !important; margin: 0 !important; box-shadow: none !important; }
  }
