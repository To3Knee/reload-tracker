...
-- ---------------------------------------------------------------
-- We truncate tables to remove old/demo data.
-- CASCADE handles the links automatically.
-- We wrap in a DO block to avoid errors if a table doesn't exist yet.
...
-- ---------------------------------------------------------------
-- This block runs if tables already exist but are missing the new 
-- columns required for the Visualizer, Images, or Analytics.

DO $$ 
BEGIN 
    -- RECIPES: Visualizer & Archiving
